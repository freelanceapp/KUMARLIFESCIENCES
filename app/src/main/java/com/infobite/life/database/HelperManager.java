...
public class HelperManager {
    ...
    public boolean insertWishlist(ProductDetail productDetail) {
        ...
        v.put(DatabaseConstant.TABLE_WISHLIST_CATEGORY, productDetail.getCategory());
        v.put(DatabaseConstant.TABLE_WISHLIST_MANUFATURING_DATE, productDetail.getManufacturing_date());
        v.put(DatabaseConstant.TABLE_WISHLIST_END_DATE, productDetail.getEnd_date());
    ...
    public boolean insertCart(ProductDetail productDetail) {
        ...
        v.put(DatabaseConstant.TABLE_CART_CATEGORY, productDetail.getCategory());
        v.put(DatabaseConstant.TABLE_CART_MANUFATURING_DATE, productDetail.getManufacturing_date());
        v.put(DatabaseConstant.TABLE_CART_END_DATE, productDetail.getEnd_date());
