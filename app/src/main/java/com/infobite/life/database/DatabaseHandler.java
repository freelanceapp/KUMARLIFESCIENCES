...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public static final String TABLE_CART_CATAGORY = "category";
    public static final String TABLE_CART_MANUFATURING_DATE = "manufaturing_date";
    public static final String TABLE_CART_END_DATE = "end_date";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_URL_TABLE = "CREATE TABLE " + TABLE_URL + "("
                ...
                + TABLE_CART_CATAGORY + " TEXT," + TABLE_CART_MANUFATURING_DATE + " TEXT," + TABLE_CART_END_DATE + " TEXT,"
    ...
    public void addItemCart(ProductDetail urlModal) {
        ...
        values.put(TABLE_CART_CATAGORY, urlModal.getCategory());
        values.put(TABLE_CART_MANUFATURING_DATE, urlModal.getManufacturing_date());
        values.put(TABLE_CART_END_DATE, urlModal.getEnd_date());
    ...
    public ProductDetail getSingleItem(int id) {
        ...
        Cursor cursor = db.query(TABLE_URL, new String[]{KEY_ID, TABLE_CART_ID, TABLE_CART_NAME, TABLE_CART_PRICE, TABLE_CART_CATAGORY
                        , TABLE_CART_MANUFATURING_DATE, TABLE_CART_END_DATE, TABLE_CART_IMAGE, TABLE_CART_IMAGES_ARRAY,
    ...
    public ArrayList<ProductDetail> getAllUrlList() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                urlModal.setCategory(cursor.getString(4));
                urlModal.setManufacturing_date(cursor.getString(5));
                urlModal.setEnd_date(cursor.getString(6));
